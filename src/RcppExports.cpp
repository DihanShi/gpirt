...
// gpirtMCMC
Rcpp::List gpirtMCMC(const arma::cube& y, arma::mat theta, const int sample_iterations, const int burn_iterations, const int THIN, const arma::mat& beta_prior_means, const arma::mat& beta_prior_sds, const arma::mat& theta_prior_means, const arma::mat& theta_prior_sds, const double& theta_os, const double& theta_ls, const std::string& KERNEL, arma::cube thresholds, const int constant_IRF, const bool store_f, const bool store_fstar);
RcppExport SEXP _gpirt_gpirtMCMC(SEXP ySEXP, SEXP thetaSEXP, SEXP sample_iterationsSEXP, SEXP burn_iterationsSEXP, SEXP THINSEXP, SEXP beta_prior_meansSEXP, SEXP beta_prior_sdsSEXP, SEXP theta_prior_meansSEXP, SEXP theta_prior_sdsSEXP, SEXP theta_osSEXP, SEXP theta_lsSEXP, SEXP KERNELSEXP, SEXP thresholdsSEXP, SEXP constant_IRFSEXP, SEXP store_fSEXP, SEXP store_fstarSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const bool >::type store_f(store_fSEXP);
    Rcpp::traits::input_parameter< const bool >::type store_fstar(store_fstarSEXP);
    rcpp_result_gen = Rcpp::wrap(gpirtMCMC(y, theta, sample_iterations, burn_iterations, THIN, beta_prior_means, beta_prior_sds, theta_prior_means, theta_prior_sds, theta_os, theta_ls, KERNEL, thresholds, constant_IRF, store_f, store_fstar));
...
static const R_CallMethodDef CallEntries[] = {
    {"_gpirt_gpirtMCMC", (DL_FUNC) &_gpirt_gpirtMCMC, 16},
